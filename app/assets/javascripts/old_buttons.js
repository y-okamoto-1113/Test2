...
//     if(($("#junior").get(0).checked==true || $("#high-school").get(0).checked==true || $("#university").get(0).checked==true) && school_value==0 ){
//         $("#careerError").show();
//         return false;
//     }else{
//         $("#careerError").fadeOut();
...
function valueCheck() {
    ...
    // nameCheck();   「required=""」と記載しているからいらん
    telCheck();
    mailCheck();
    sexCheck();
    careerCheck();
    joinedCheck();
    // frCheck();  「required=""」と記載しているからいらん
    ...
    if( mailCheck()==true && sexCheck()==true &&
      careerCheck()==true && telCheck()==true && joinedCheck()==true ) {
